...
<body>
    ...
    <main>
        <form action="" method="post">
            ...
            <input type="text" name="nom" value="<?= $_SESSION["modification"]["client_nom"] ?>" required><?= isset($erreurs['nom']) ? $erreurs['nom'] : ""  ?><br>
            <label for="prenom">Prénom : </label>
            <input type="text" name="prenom" value="<?= $_SESSION["modification"]["client_prenom"] ?>" required><?= isset($erreurs['prenom']) ? $erreurs['prenom'] : ""  ?><br>
            <label for="email">Email : </label>
            <input type="text" name="email" value="<?= $_SESSION["modification"]["client_email"] ?>" required><?= isset($erreurs['email']) ? $erreurs['email'] : ""  ?><br>
            <label for="telephone">Téléphone : </label>
            <input type="text" name="telephone" value="<?= $_SESSION["modification"]["client_telephone"] ?>" required><?= isset($erreurs['telephone']) ? $erreurs['telephone'] : ""  ?><br>
            <label for="adresse">Adresse : </label>
            <input type="text" name="adresse" value="<?= $_SESSION["modification"]["client_adresse"] ?>" required><?= isset($erreurs['adresse']) ? $erreurs['adresse'] : ""  ?><br>
            ...
            <input type="text" name="ville" value="<?= $_SESSION["modification"]["client_ville"] ?>" required><?= isset($erreurs['ville']) ? $erreurs['ville'] : ""  ?><br>
            <label for="cp">Code Postal : </label>
            <input type="text" name="cp" value="<?= $_SESSION["modification"]["client_cp"] ?>" required><?= isset($erreurs['cp']) ? $erreurs['cp'] : ""  ?><br>
