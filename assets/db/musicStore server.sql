...
-- -----------------------------------------------------
-- Schema sachixcu_musicstore
-- -----------------------------------------------------

-- -----------------------------------------------------
-- Schema sachixcu_musicstore
-- -----------------------------------------------------
CREATE SCHEMA IF NOT EXISTS `sachixcu_musicstore` DEFAULT CHARACTER SET utf8 ;
USE `sachixcu_musicstore` ;

-- -----------------------------------------------------
-- Table `sachixcu_musicstore`.`utilisateurs`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `sachixcu_musicstore`.`utilisateurs` (
...
-- -----------------------------------------------------
-- Table `sachixcu_musicstore`.`clients`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `sachixcu_musicstore`.`clients` (
...
-- -----------------------------------------------------
-- Table `sachixcu_musicstore`.`Categories`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `sachixcu_musicstore`.`categories` (
...
-- -----------------------------------------------------
-- Table `sachixcu_musicstore`.`Produits`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `sachixcu_musicstore`.`produits` (
  ...
  CONSTRAINT `fk_produits_catégories1`
    ...
    REFERENCES `sachixcu_musicstore`.`categories` (`categorie_id`))
ENGINE = InnoDB;


-- -----------------------------------------------------
-- Table `sachixcu_musicstore`.`Commandes`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `sachixcu_musicstore`.`commandes` (
  ...
  CONSTRAINT `fk_commandes_clients`
    ...
    REFERENCES `sachixcu_musicstore`.`clients` (`client_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `sachixcu_musicstore`.`Commandes_Produits`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `sachixcu_musicstore`.`commandes_produits` (
  ...
  CONSTRAINT `fk_commandes_has_produits_commandes1`
    ...
    REFERENCES `sachixcu_musicstore`.`commandes` (`commande_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_commandes_has_produits_produits1`
    FOREIGN KEY (`fk_produit_id`)
    REFERENCES `sachixcu_musicstore`.`produits` (`produit_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
VALUES
  ("Pignot", "Sacha", "admin@sachixcu_musicstore.com", SHA2('admin', 256), "administrateur"),

  ("Marc", "Jean", "Jean@sachixcu_musicstore.com", SHA2('jean', 256), "gestionnaire"),
  ("Mazi", "Jeanne", "Jeanne@sachixcu_musicstore.com", SHA2('jeanne', 256), "gestionnaire"),

  ("Lopez", "Carlos", "Carlos@sachixcu_musicstore.com", SHA2('carle', 256), "vendeur"),
  ("Laza", "Clara", "Clara@sachixcu_musicstore.com", SHA2('clara', 256), "vendeur"),
  ("Ledragon", "Elliotte", "Elliotte@sachixcu_musicstore.com", SHA2('elliotte', 256), "vendeur");
